...
export default function Services() {
  ...
  return (
    <section id="services" ref={ref} style={{ background: '#080610', padding: '100px 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div className="reveal text-center mb-16" style={{ opacity: 0, transform: 'translateY(30px)', transition: 'all 0.7s cubic-bezier(0.22,1,0.36,1)' }}>
          ...
          <h2 className="gradient-text" style={{ fontFamily: "'Instrument Serif', serif", fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1, marginBottom: '16px' }}>
            Two Services, One Vision
          </h2>
          <p style={{ fontFamily: "'Inter', sans-serif", color: 'rgba(255,255,255,0.55)', fontSize: '1.05rem', maxWidth: '500px', margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '28px', marginBottom: '60px' }}>
          {services.map((svc, i) => (
            ...
            >
              ...
              <h3 style={{ fontFamily: "'Instrument Serif', serif", color: 'white', fontSize: '1.6rem', marginBottom: '12px', lineHeight: 1.2 }}>
                {svc.title}
              </h3>
